/*Consigna de metodo:
Implemente un método llamado esPalindromo que reciba una cadena de texto 
y evalue si es un palindromo o no. el metodo debe devolver un booleano y 
debe ser true para los textos que si son palindromos y false para aquellos que no.*/
